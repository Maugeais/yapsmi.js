...
let convolver;
let reverb_file = "../../effects/reverb-v1.2.plugin/data/Waves Hallway_xcg1v2.wav";
...
async function load_reverb_files(){
    $.ajax({
        url: `../../effects/reverb-v1.2.plugin/data/`,
 ...
 window.select_reverb = async function(element) {
    ...
    reverb_file = "../../effects/reverb-v1.2.plugin/data/"+$(element).text()+".wav";
    set_reverb_file()
};
...
$('#reverb_table td').click(async function () {
        ...
        reverb_file = "../../effects/reverb-v1.2.plugin/data/"+$(this).text()+".wav";
        set_reverb_file()
    });
function save(uid){
