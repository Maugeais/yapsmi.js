...
class duduk extends instrument{
...
class microphone{
    ...
    addEffect(audioCtx, source){
        
        /*this.compressor = audioCtx.createDynamicsCompressor();
        this.compressor.threshold.setValueAtTime(-20, audioCtx.currentTime);
        this.compressor.knee.setValueAtTime(0, audioCtx.currentTime);
        this.compressor.ratio.setValueAtTime(19, audioCtx.currentTime);
        this.compressor.attack.setValueAtTime(0.001, audioCtx.currentTime);
        this.compressor.release.setValueAtTime(0.1, audioCtx.currentTime);
